...
def setup(sim):
    ...
    sig = GridDiffusion(sim, n_signals, grid_dim, grid_size, grid_orig, D=[Diff_A], initLevels=[ANTIBIOTIC])
...
def update(cells):
    ...
    for (id, cell) in cells.items():
        ...
        if cell.cellType==0:
            ...
            cell.color = [0.1, 0.6, 0.1] 

        else:
            cell.growthRate = lambda_r
